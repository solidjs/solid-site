    ...
    <>
      <Transition onEnter={onEnterBigHeader} onExit={onExitBigHeader}>
        <Show when={showHeaderSplash()}>
          <header
            id="header"
            class="relative mx-2 rounded-br-3xl rounded-bl-3xl bg-gradient-to-r from-solid-light via-solid-medium to-yellow-500 dark:from-solid-light/70 dark:via-solid-medium/50 dark:to-solid-default/50 text-white overflow-hidden z-[1]"
          >
        ...
        <Transition onEnter={onEnterSmallHeader} onExit={onExitSmallHeader}>
          <Show when={showHeaderSmall() && !location.pathname.includes('/hack')}>
            <header class="overflow-hidden">
              <div class="bg-gradient-to-r from-solid-light via-solid-medium to-yellow-500 dark:from-solid-light/40 dark:via-solid-medium/40 dark:to-solid-default/40 text-white text-center md:text-left rtl:text-right">
