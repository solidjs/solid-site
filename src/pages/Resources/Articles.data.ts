...
const articles: Array<Resource> = [
  ...
  },
  {
    link: 'https://dev.to/this-is-learning/client-side-routing-without-the-javascript-3k1i',
    title: 'Client-side Routing without the JavaScript',
    description: 'Ryan discusses client-side routing without JavaScript as it relates to different frameworks.',
    author: 'Ryan Carniato',
    author_url: 'https://dev.to/ryansolid',
  ...
  },
  {
    ...
    description: 'Ryan discusses React versus Signals in 2023 and provides some insight into the larger debate on approaches.',
    author: 'Ryan Carniato',
    author_url: 'https://dev.to/ryansolid',
