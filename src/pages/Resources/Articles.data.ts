...
const articles: Array<Resource> = [
  ...
  },
  {
    ...
    description: "An article discussing practical use of SolidJS from Vlad's direct experience.",
  ...
  },
  {
    ...
    description: 'Vlad walks us through practical use of Solid today.',
    author: 'Vladislav Lipatov',
    author_url: 'https://vladislav-lipatov.medium.com/',
  ...
  {
    link: 'https://www.smashingmagazine.com/2024/01/solidstart-different-breed-meta-framework/',
    ...
    author_url: 'https://www.smashingmagazine.com/author/atila-fassina/',
  ...
  {
    link: 'https://dev.to/lexlohr/deploy-a-solid-start-app-on-github-pages-2l2l',
    title: 'Deploy a solid-start app on github pages',
    description: 'In this article, Alex explains how to deploy a SolidStart app on github pages.',
    author: 'Alex Lohr',
    author_url: 'https://dev.to/lexlohr',
    keywords: ['solid', 'solidstart', 'deploying', 'github pages'],
    type: ResourceType.Article,
    categories: [ResourceCategory.Educational],
    published_at: 1709126698495,
  },
  {
    link: 'https://dev.to/lexlohr/the-zen-of-state-in-solidjs-22lj',
    title: 'The zen of state in Solid.js',
    description:
      'In this article, Alex gives an overview on Solid fundamentals while following a zen approach.',
    author: 'Alex Lohr',
    author_url: 'https://dev.to/lexlohr',
    keywords: ['solid', 'signals', 'stores', 'memos', 'effects', 'resources'],
    type: ResourceType.Article,
    categories: [ResourceCategory.Educational],
    published_at: 1709126698495,
  },
  {
    link: 'https://dev.to/lexlohr/of-solid-primitives-part-1-context-2bah',
    title: '💎 of solid-primitives, part 1: context',
    description: 'In this article, Alex gives an overview on one of the solid primitives',
    author: 'Alex Lohr',
    author_url: 'https://dev.to/lexlohr',
    keywords: ['solid', 'primitives', 'context'],
    type: ResourceType.Article,
    categories: [ResourceCategory.Primitives],
    published_at: 1709126698495,
  },
  {
    link: 'https://www.brenelz.com/posts/learning-four-key-primitives-in-solid/',
    title: 'Learning Four Key Primitives In Solid',
    description: 'In this article, Brenley gives an overview on four Solid primitives',
    author: 'Brenley Dueck',
    author_url: 'https://www.brenelz.com/',
    keywords: ['solid', 'primitives', 'signals', 'actions', 'server functions', 'async'],
    type: ResourceType.Article,
    categories: [ResourceCategory.Educational],
    published_at: 1709126698495,
  },
  {
    ...
    description: 'Solid: how far can primitives go?',
    author: 'Bobae Kang',
    author_url: 'https://bobaekang.com/',
    keywords: ['solid', 'solidstart'],
    type: ResourceType.Article,
    categories: [ResourceCategory.Educational],
    published_at: 1709126698495,
