...
So we are very happy to announce that the Chrome team through [Aurora](https://developer.chrome.com/blog/introducing-aurora/) will be contributing $30,000 towards our continued performance research. Aurora funds improvements to Core Web Vitals in open source frameworks.
