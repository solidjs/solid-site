...
import { compiler, formatter, Repl, createTabList } from '../../components/setupRepl';
import type { TutorialDirectory, TutorialDirectoryItem, TutorialRouteData } from './[id].data';
...
const SolidMarkdown = lazy(() => (isServer ? import('./simple') : import('solid-markdown')));
    ...
    <Suspense fallback={<p>Loading...</p>}>
      ...
      >
        <div class="flex flex-col bg-gray-50 dark:bg-solid-darkbg h-full overflow-hidden border-r-2 dark:border-solid-darkLighterBg border-grey mb-10 md:mb-0 ">
          ...
          <Show when={!isServer && data.markdown} fallback={''}>
            {(markdown) => (
              <div
                ref={markDownRef}
