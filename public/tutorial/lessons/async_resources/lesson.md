Resources are special Signals designed specifically to handle Async loading. They can be driven by a source signal that provides the query to a async data fetcher function that returns a promise.
